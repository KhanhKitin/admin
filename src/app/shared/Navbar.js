              ...
              <Dropdown alignRight>
                <Dropdown.Toggle className="nav-link">
                  <div className="nav-profile-img">
                    <img src={'https://res.cloudinary.com/dxwkzyyc9/image/upload/v1639495622/my-memory/e28gsk8hsxdifv0wnkth.png'} alt="user"/>
                    <span className="availability-status online"></span>
                  </div>
                  <div className="nav-profile-text">
                    <p className="mb-1 text-black"><Trans>KhanhHQ</Trans></p>
                  </div>
                </Dropdown.Toggle>
